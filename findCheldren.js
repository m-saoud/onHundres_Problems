...
// function rVoP(obj = { continent: "", country: "" }) {
//   return Object(obj.country);
// }
// console.log(rVoP({ continent: "Asia", country: "Japan" }));

// function myFunction(a, b) {
//   return a + b;
// }

// function chekTowValue(obj = { continent: "", country: "" }, key) {
//   if (key in obj) {
//     return obj[key];
//   }
// }
// console.log(chekTowValue({ continent: "Asia", country: "Japan" }, "continent")); //'Asia'

// function checkEqual(a, b) {
//   return a === b && typeof a === typeof b ? true : false;
// }
// console.log(checkEqual(3, "d"));

// function returnLstThree(a) {
//   return a.slice(a.length - 3);
// }
// console.log(returnLstThree([5, 4, 3, 2, 1, 0]));

function reObjectVal(a) {
  obj = {
    key: a,
  };
  return obj.key;
}
console.log(reObjectVal("s"));

// function removelastChar(a) {
//   return a.slice(0, a.length - 3);
// }
// console.log(removelastChar("1234"));

function returnIndex(a, n) {
  return a[n - 1];
}

// console.log(returnIndex("gfedcba", 3)); //w
...
// console.log(cheSmallerThan(90, 45)); //0.1

// function cheInSet(set, val) {
//   return set.has(val);
// }
// console.log(cheInSet(new Set([1, 2, 3]), 2)); //true

function truthValue(a, b) {
  a = { a: "", b: "", c: "" };
...
console.log(truthValue({x:'a',b:'b',z:undefined},'z' )); //true
...
function extractkeys(a={a:'',b:'',c:''}) {
  return Object.keys(a)
}

console.log(extractkeys({ j: 9, i: 2, x: 3, z: 4 }))

function ChecIfOneDateIsEarlierthanAnother(a,b) {
  if (a instanceof Date && b instanceof Date) {
    return a.getTime()< b.getTime()
  }
}

console.log(ChecIfOneDateIsEarlierthanAnother(new Date('2000/01/01 08:00:00'), new Date('2000/01/01 08:45:00')))
